...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<Entire> entireList;
    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    RecyclerView.Adapter historyAdapter;
    RecyclerView.Adapter entireAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnSuggestionListener(new SearchView.OnSuggestionListener() {
            ...
            public boolean onSuggestionClick(int position) {
                ...
                Log.d(TAG, "onSuggestionClick: " + clicked_word);
        ...
        recyclerView = (RecyclerView)findViewById(R.id.recycler_view_entire);
    ...
    private void fetch_entire()
    {
        entireList=new ArrayList<>();
        entireAdapter = new RecyclerViewAdapterEntire(this,entireList);
        recyclerView.setAdapter(entireAdapter);

        Entire e;

        if(databaseOpened)
        {
            cursorEntire=myDbHelper.getEntire();
            if (cursorEntire.moveToFirst()) {
                do {
                    e= new Entire(cursorEntire.getString(cursorEntire.getColumnIndex("en_word")));
                    entireList.add(e);
                }
                while (cursorEntire.moveToNext());
            }

            entireAdapter.notifyDataSetChanged();
        }


        if (entireAdapter.getItemCount() == 0)
        {
            emptyHistory.setVisibility(View.VISIBLE);
        }
        else
